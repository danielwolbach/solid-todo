...
export default function CheckboxInput(props: Readonly<Props>) {
    return (
        <label className="relative inline-flex h-5 w-5 cursor-pointer items-center justify-center">
            ...
            <span className="h-5 w-5 rounded-md border border-zinc-300 bg-white transition-colors hover:bg-zinc-100 peer-checked:border-zinc-800 peer-checked:bg-zinc-800 peer-checked:hover:bg-zinc-700 peer-focus-visible:ring-2 peer-focus-visible:ring-zinc-800 peer-focus-visible:ring-offset-2 peer-focus-visible:outline-none dark:border-zinc-600 dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:peer-checked:border-zinc-200 dark:peer-checked:bg-zinc-200 dark:peer-checked:hover:bg-zinc-300 dark:peer-focus-visible:ring-zinc-200 dark:peer-focus-visible:ring-offset-zinc-900" />
